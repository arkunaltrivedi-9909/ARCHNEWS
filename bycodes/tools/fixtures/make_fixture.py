...
# --- Synthetic amendment notification ---------------------------------------
# Shaped like a real BIS/Gujarat amendment: bracketed page+clause locators and
# substitute/insert/delete instructions. Also fictional. Used so amendment
# handling can be tested without shipping copyright material.

AMENDMENT_PAGES = [[
    BANNER,
    "AMENDMENT NO. 4 JANUARY 2024",
    "TO",
    "SAMPLE DEVELOPMENT CONTROL REGULATIONS, TEST EDITION",
    "This amendment amends the provisions of Part II 'Planning' of the Code, as follows:",
    "(Page 2, clause 2.1, line 2) - Substitute '2.25' for '1.8'.",
    "[Page 3, clause 3.1 (b)] - Delete the words 'subject to prior approval'.",
    "(Page 4, Table 4.1, Note 2) - Insert the following at the end:",
    "'For plots abutting a road of 18 m or more, see 6.4.2.'",
    "[Pages 4 and 5, clause 4.1] - Substitute the following for the existing:",
    "'4.1 Common Plot - A common plot of not less than 10 percent shall be provided.'",
]]
...
def main():
    ...
    amd = os.path.join(here, "sample-amendment-FIXTURE.pdf")
    build_pdf(AMENDMENT_PAGES, amd)
    print(f"wrote {amd} ({len(AMENDMENT_PAGES)} pages)")
